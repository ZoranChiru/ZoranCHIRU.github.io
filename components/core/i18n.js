const translations = {
  ...
  fr: {
    ...
    bde: {
      ...
      ev1_p1: 'Organisation d\'un tournoi de football réunissant toutes les promotions du département GEII. Logistique, inscriptions, arbitrage, communication — tout était géré par le BDE.',
  ...
  en: {
    ...
    bde: {
      ...
      ev1_p1: 'Organization of a football tournament bringing together all GEII department year groups. Logistics, registrations, refereeing, communication — all managed by the student union.',
  ...
  ro: {
    ...
    bde: {
      ...
      ev1_p1: 'Organizarea unui turneu de fotbal reunind toate promoțiile departamentului GEII. Logistică, înregistrări, arbitraj, comunicare — totul gestionat de asociație.',
