    ...
    content() {
      return {
        fr: {
          ...
          intro_p1: 'Intégré à l\'ENSICAEN en septembre 2024, je suis actuellement en deuxième année du cursus ingénieur GPSE, Génie Physique et Systèmes Embarqués. Une formation qui couvre un spectre large : de l\'électronique hyperfréquence à la programmation temps réel, en passant par l\'instrumentation et la conception de systèmes embarqués.',
          intro_p2: 'Le cursus est en alternance, ce qui m\'a permis d\'appliquer directement les compétences acquises en cours dans un contexte industriel réel dès la première année.',
        ...
        en: {
          ...
          intro_p1: 'I joined ENSICAEN in September 2024 and am currently in my second year of the GPSE engineering program, Physical Engineering and Embedded Systems. A broad program covering everything from microwave electronics to real-time programming, instrumentation and embedded system design.',
          intro_p2: 'The program is work-study based, which allowed me to directly apply skills from class in a real industrial context from the very first year.',
          competences_eyebrow: 'Skills developed',
          competences_titre: 'What we actually learn',
          competences_p: 'Coursework covers RF electronics with ADS simulation, real-time systems with FreeRTOS on STM32, instrumentation and signal processing, as well as full PCB design: schematic, routing, assembly and validation.',
        ...
        ro: {
          ...
          intro_p1: 'Am intrat la ENSICAEN în septembrie 2024 și sunt în prezent în al doilea an al programului de inginerie GPSE, Inginerie Fizică și Sisteme Incorporate. Un program vast care acoperă electronica de înaltă frecvență, programarea în timp real, instrumentarea și proiectarea sistemelor incorporate.',
          intro_p2: 'Programul este în alternance, ceea ce mi-a permis să aplic direct competențele dobândite în cursuri într-un context industrial real încă din primul an.',
          competences_eyebrow: 'Competențe dezvoltate',
          competences_titre: 'Ce învățăm concret',
          competences_p: 'Cursurile acoperă electronica RF cu simulare ADS, sisteme în timp real cu FreeRTOS pe STM32, instrumentare și procesarea semnalelor, dar și proiectarea completă a plăcilor electronice: schemă, rutare, asamblare și validare.',
